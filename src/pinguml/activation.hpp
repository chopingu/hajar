...
auto null = []([[maybe_unused]] f32 *input, [[maybe_unused]] const f32 *biases, [[maybe_unused]] const u32 size) {
    return;
};

auto null_c = []([[maybe_unused]] f32 *input, [[maybe_unused]] const f32 bias, [[maybe_unused]] const u32 size) {
    return;
};
