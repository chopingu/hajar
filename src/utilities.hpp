...
template<class T>
void tanh(std::span<T> input, std::span<const T> bias, const usize _size) {
...
template<class T>
T d_tanh(std::span<const T> input, const usize index) {
    return (1.0f - input[index] * input[index]);
} // input[index] is already activated here

template<class T>
void identity(std::span<T> input, std::span<const T> bias, const usize _size) {
    for (usize i = 0; i < _size; i++)
...
template<class T>
T d_elu(std::span<const T> input, const usize index) {
    if (input[index] > 0) return 1.0f;
    else return 0.1f * std::exp(input[index]);
}

template<class T>
void relu(std::span<T> input, std::span<const T> bias, const usize _size) {
    for (usize i = 0; i < _size; i++) {
        const T x = input[i] + bias[i];
        if (x < 0) input[i] = 0;
        else input[i] = x;
...
template<class T>
T d_relu(std::span<const T> input, const usize index) {
    if (input[index] > 0) return 1.0f;
    else return 0.0f;
}

template<class T>
void lrelu(std::span<T> input, std::span<const T> bias, const usize _size) {
    for (usize i = 0; i < _size; i++) {
        const T x = input[i] + bias[i];
...
template<class T>
T d_lrelu(std::span<const T> input, const usize index) {
    if (input[index] > 0) return 1.0f;
    else return 0.01f;
}

template<class T>
void vlrelu(std::span<T> input, std::span<const T> bias, const usize _size) {
    for (usize i = 0; i < _size; i++) {
        const T x = input[i] + bias[i];
...
template<class T>
T d_vlrelu(std::span<const T> input, const usize index) {
    if (input[index] > 0) return 1.0f;
    else return 0.2f;
}

template<class T>
void sigmoid(std::span<T> input, std::span<const T> bias, const usize _size) {
    for (usize i = 0; i < _size; i++) {
        const T x = input[i] + bias[i];
...
template<class T>
T d_sigmoid(std::span<const T> input, const usize index) {
    return input[index] * (1.0f - input[index]);
} // input[index] is already activated

template<class T>
void softmax(std::span<T> input, std::span<const T> bias, const usize _size) {
    T mx = input[0] + bias[0];
    for (usize i = 0; i < _size; i++) {
        const T x = input[i] + bias[i];
        if (mx < x) mx = x;
...
template<class T>
T d_softmax(std::span<const T> input, const usize index) {
    return input[index] * (1.0f - input[index]);
} // input[index] is already activated
...
template<class T>
void tanh(std::span<T> input, const usize _size) {
    for (usize i = 0; i < _size; i++) {
        const T x = input[i];
        const T e1 = std::exp(x);
        const T e2 = std::exp(-x);
...
template<class T>
void elu(std::span<T> input, const usize _size) {
    for (usize i = 0; i < _size; i++) {
        const T x = input[i];
        if (x < 0) input[i] = 0.1f * (std::exp(x) - 1.0f);
        else input[i] = x;
...
template<class T>
void relu(std::span<T> input, const usize _size) {
    for (usize i = 0; i < _size; i++) {
        const T x = input[i];
        if (x < 0) input[i] = 0;
        else input[i] = x;
...
template<class T>
void lrelu(std::span<T> input, const usize _size) {
    for (usize i = 0; i < _size; i++) {
        const T x = input[i];
        if (x < 0) input[i] = 0.01f * x;
        else input[i] = x;
...
template<class T>
void vlrelu(std::span<T> input, const usize _size) {
    for (usize i = 0; i < _size; i++) {
        const T x = input[i];
        if (x < 0) input[i] = 0.2f * x;
        else input[i] = x;
...
template<class T>
void sigmoid(std::span<T> input, const usize _size) {
    for (usize i = 0; i < _size; i++) {
        const T x = input[i];
        input[i] = 1.0f / (1.0f + std::exp(-x));
    }
...
template<class T>
void softmax(std::span<T> input, const usize _size) {
    T mx = 0;
    for (usize i = 0; i < _size; i++) {
        const T x = input[i];
        if (mx < x) mx = x;
